package factory.legacy;//SandboxBraviaCart
 ...
 * @author John Mwai
 */
public class SandboxBraviaCart extends ComponentProject {

    public SandboxBraviaCart(Component myComponent) {
        super(myComponent);
    }

    public static void main(String[] args) {

        String name = "BraviacartSandbox";
        ...
        SandboxBraviaCart braviaCartImpl = new SandboxBraviaCart(braviacart);
        braviaCartImpl.make();
    ...
    private class AcademicLevels extends ComponentProject.ListDetailsViewMaker {
    ...
    /*
     */
    private class Attachments extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Countries extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Messages extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Coupons extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Customers extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleProjectTypes extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleTones extends ComponentProject.ListDetailsViewMaker {
    ...
    private class DocTypes extends ComponentProject.ListDetailsViewMaker {
    ...
    private class EmailTemplates extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Ipns extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleOrders extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleTitles extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleLengths extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ArticleCategories extends ComponentProject.ListDetailsViewMaker {
    ...
    private class AcademicOrders extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Orders extends ComponentProject.ListDetailsViewMaker {
    ...
    private class NumberOfWords extends ComponentProject.ListDetailsViewMaker {
    ...
    private class OrderStyles extends ComponentProject.ListDetailsViewMaker {
    ...
    private class LanguageStyles extends ComponentProject.ListDetailsViewMaker {
    ...
    private class SentEmails extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Spacings extends ComponentProject.ListDetailsViewMaker {
    ...
    private class SubjectAreas extends ComponentProject.ListDetailsViewMaker {
    ...
    private class TermsOfServices extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Urgencies extends ComponentProject.ListDetailsViewMaker {
    ...
    private class Writers extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ClientMessages extends ComponentProject.ListDetailsViewMaker {
    ...
    private class ClientOrders extends ComponentProject.ListDetailsViewMaker {
