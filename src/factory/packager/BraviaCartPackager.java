 ...
 * @author John Mwai
 */
public class BraviaCartPackager extends SimplePackager{

    public BraviaCartPackager(boolean solicitComment,
...
//        File zippedDir = new File(rootDir + ".zip");
    ...
    public static void main(String[] args) {
        ...
        BraviaCartPackager sp = new BraviaCartPackager(true, false);
