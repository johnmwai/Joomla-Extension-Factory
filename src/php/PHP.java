...
public class PHP/*@bgen(jjtree)*/implements PHPTreeConstants, PHPConstants {/*@bgen(jjtree)*/
  protected JJTPHPState jjtree = new JJTPHPState();int mwaicounter = 0;
...
try {ParseException e = generateParseException();  // generate the exception object.
  ...
  final public ASTPhpPage PhpPage() throws ParseException {
 /*@bgen(jjtree) PhpPage */
  ...
  final public ASTHtmlBlock HtmlBlock() throws ParseException {
